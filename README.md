...
Neste momento está na fase MVP, contemplando as funcionalidades básicas, sendo elas: Cadastro de tarefas, Ordernação pelas mais recentes, Marcar tarefas concluídas, Excluir tarefas e Modo Escuro. No decorrer haverá implementações técnicas como Testes Unitários, DevOps etc., e novas funcionalidades serão implementadas, como Editar tarefa, Agrupamento por dia, Categoria/filtro por categoria etc.
